...
<pre> ```conda create -n FCE python=3.9 -y ``` </pre>

<pre> ```conda activate FCE ``` </pre>

<pre> ```conda install pytorch torchvision torchaudio pytorch-cuda=11.8 -c pytorch -c nvidia ``` </pre>
